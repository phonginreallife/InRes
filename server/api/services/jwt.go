...
func NewJWTService(secretKey string) *JWTService {
	if secretKey == "" {
		secretKey = "inres-default-secret-key-change-in-production"
		// Set SUPABASE_JWT_SECRET or jwt_secret in your config file
		println("WARNING: Using default JWT secret key - NOT SECURE FOR PRODUCTION")
	}
